...
sentences = [
    ...
    ['ich mochte ein Banane P', 'S i want a banana .', 'i want a banana . E']
]

# Padding Should be Zero
src_vocab = {'P': 0, 'ich': 1, 'mochte': 2, 'ein': 3, 'bier': 4, 'cola': 5, 'Banane': 6}
src_vocab_size = len(src_vocab)

tgt_vocab = {'P': 0, 'i': 1, 'want': 2, 'a': 3, 'beer': 4, 'coke': 5, 'banana': 6, 'S': 7, 'E': 8, '.': 9}
